...
public class CanIBuy {
    ...
    /** В данном случае метод и не нужен, так как логика основана на рандоме, но если переписать на получение данных со
     сканера то метод будет работать */
